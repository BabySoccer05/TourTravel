    ...
    <body>
        ...
        <div id="root-container" class="container">
            <div id="wrapper" class="sixteen columns">
                ...
                <div id="content">
                    <div id="intro">
                        <h1><span>Welcome to AGUS Travel</span></h1>
                        <!-- <br><center><p>Repost by <a href='https://shopee.co.id/kokoqory' title='Kokoqory' target='_blank'>Kokoqory</a></p></center> -->
                        
                        <p style="text-align: center;">
                            AGUS Travel Adalah Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                        </p>
                        <p>
